...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Link href={`/projects/${project.slug}`}>
      <article className="garden-card-hover p-5 evergreen">
        {/* Header */}
        <div className="flex items-start justify-between mb-3">
          ...
          <svg className="w-4 h-4 text-gray-400 group-hover:text-garden-500 transition-colors flex-shrink-0 mt-1" 
        ...
        {/* Date */}
        <time className="text-xs text-gray-500 dark:text-gray-500 font-mono block mb-2">
          {formatDate(date)}
        </time>
