  ...
  return (
    <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <nav className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-8">
        ...
        <span>/</span>
        <Link href="/projects" className="hover:text-garden-600 dark:hover:text-garden-400 transition-colors">
          Projects
        </Link>
        <span>/</span>
      ...
      <div className="grid gap-10 lg:grid-cols-[1fr_300px]">
        ...
        <article>
          <header className="mb-8">
            <h1 className="font-mono font-bold text-3xl sm:text-4xl text-gray-900 dark:text-gray-100">
              {title}
            </h1>
        ...
        <aside className="lg:sticky lg:top-24 self-start">
          <div className="garden-card p-5 space-y-5">
            {/* Tech stack */}
            <div>
              <h3 className="text-xs font-mono font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3">
                技术栈
              </h3>
            ...
            {/* Date */}
            <div>
              <h3 className="text-xs font-mono font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">
                创建时间
              </h3>
